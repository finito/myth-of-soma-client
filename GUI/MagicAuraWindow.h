#ifndef GUI_MAGIC_AURA_WINDOW_H
#define GUI_MAGIC_AURA_WINDOW_H
...
const int MAGIC_AURA_SLOT_COUNT = 5;
...
private:
	...
	CEGUI::Window*		  iconSlots_[MAGIC_AURA_SLOT_COUNT];
	CEGUI::Window*		  descriptionSlots_[MAGIC_AURA_SLOT_COUNT];
