#ifndef GUI_MAGIC_BLUE_WINDOW_H
#define GUI_MAGIC_BLUE_WINDOW_H
...
const int MAGIC_BLUE_SLOT_COUNT = 5;
...
private:
	...
	CEGUI::Window*		  iconSlots_[MAGIC_BLUE_SLOT_COUNT];
	CEGUI::Window*		  descriptionSlots_[MAGIC_BLUE_SLOT_COUNT];
