#ifndef GUI_MAGIC_ABILITY_WINDOW_H
#define GUI_MAGIC_ABILITY_WINDOW_H
...
const int MAGIC_ABILITY_SLOT_COUNT = 5;
...
private:
	...
	CEGUI::Window*		  iconSlots_[MAGIC_ABILITY_SLOT_COUNT];
	CEGUI::Window*		  descriptionSlots_[MAGIC_ABILITY_SLOT_COUNT];
...
#endif // GUI_MAGIC_ABILITY_WINDOW_H